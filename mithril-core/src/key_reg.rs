...
mod tests {
    ...
    fn test_vector_key_reg() {
        ...
        let fake_pool_id = [134, 128, 179, 254, 245, 165, 179, 39, 71, 156, 226, 254, 129, 15, 231, 1, 142, 176, 236, 148, 207, 175, 146, 72, 222, 186, 20, 75, 111, 34, 204, 43];
        ...
        let cbor_bytes = Vec::from_hex("").expect("Invalid Hex String");
        assert!(key_reg.register(&cbor_bytes, initializer.kes_sig.unwrap(), 0, initializer.pk).is_ok());
    }
}
